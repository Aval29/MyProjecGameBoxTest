...
public class SnowBoll : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    private float _tempUp =2;
    private float _manaUp =3;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (colls != null && colls.transform.gameObject.GetComponent<SnowBoll>() == true)
        {
    ...
    private void snowFlakeMelted()
    {
        ...
        EventWorld.ManaPoint += _manaUp/2;
